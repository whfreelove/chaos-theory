...
- All "defer-release" gaps:
  ...
  2. Develop 4 plausible rationale approaches
    - Autonomously consider the functional/technical scope/capability/risk impacts of deferment
    - Determine plausible rationale for the impacts
    - Decide where it should be recorded (Functional Out of Scope, Functional Known Risk, Technical Decision, Technical Known Risk, or combinations)
...
- All "defer-resolution" gaps:
  1. Record decision as "blocking release, but defer resolution" to `gaps.md`
