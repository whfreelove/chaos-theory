...
class TestFsmJsonValidation:
    ...
    def test_valid_fsm_creates_tasks(self, task_dir, skill_dir, run_hook):
    ...
    def test_malformed_json_fails(self, task_dir, skill_dir, run_hook):
    ...
    def test_not_array_fails(self, task_dir, skill_dir, run_hook):
    ...
    def test_missing_id_fails(self, task_dir, skill_dir, run_hook):
    ...
    def test_missing_subject_fails(self, task_dir, skill_dir, run_hook):
    ...
    def test_duplicate_id_fails(self, task_dir, skill_dir, run_hook):
    ...
    def test_invalid_dependency_ref_fails(self, task_dir, skill_dir, run_hook):
...
class TestIdTranslation:
    ...
    def test_empty_task_dir_no_offset(self, task_dir, skill_dir, run_hook):
    ...
    def test_existing_tasks_offset_ids(self, task_dir_with_manual_task, skill_dir, run_hook):
    ...
    def test_dependencies_use_translated_ids(self, task_dir_with_manual_task, skill_dir, run_hook):
...
class TestFsmTaskDeletion:
    ...
    def test_fsm_tasks_deleted(self, task_dir_with_fsm_tasks, skill_dir, run_hook):
    ...
    def test_manual_tasks_preserved(self, task_dir_with_manual_task, task_dir_with_fsm_tasks, skill_dir, run_hook):
...
class TestAtomicBehavior:
    ...
    def test_validation_error_preserves_tasks(self, task_dir_with_fsm_tasks, skill_dir, run_hook):
...
class TestScopePrecedence:
    ...
    def test_project_skill_precedes_user_skill(self, task_dir, tmp_path, run_hook):
    ...
    def test_plugin_local_precedes_project_and_user(self, task_dir, tmp_path, installed_plugins_file, run_hook):
    ...
    def test_plugin_not_found_falls_back_to_non_plugin(self, task_dir, tmp_path, installed_plugins_file, run_hook):
...
class TestFormatDetection:
    ...
    def test_v2_format_detected(self, task_dir, tmp_path, installed_plugins_file, run_hook):
    ...
    def test_v1_format_detected(self, task_dir, tmp_path, installed_plugins_file, run_hook):
...
class TestV2Scoping:
    ...
    def test_v2_local_precedes_project(self, task_dir, tmp_path, run_hook):
    ...
    def test_v2_project_precedes_user(self, task_dir, tmp_path, run_hook):
    ...
    def test_v2_user_scope_no_project_path_filter(self, task_dir, tmp_path, run_hook):
...
class TestV2MultiKeyRegistry:
    ...
    def test_v2_multi_key_plugin_resolution(self, task_dir, tmp_path, v2_multi_key_plugins, run_hook):
...
class TestV2Validation:
    ...
    def test_v2_missing_version_field_fails(self, task_dir, tmp_path, installed_plugins_file, run_hook):
    ...
    def test_v2_unsupported_version_fails(self, task_dir, tmp_path, installed_plugins_file, run_hook):
    ...
    def test_v2_missing_plugins_field_fails(self, task_dir, tmp_path, installed_plugins_file, run_hook):
    ...
    def test_v2_plugins_not_object_fails(self, task_dir, tmp_path, installed_plugins_file, run_hook):
...
class TestV2DeprecationNotice:
    ...
    def test_v1_emits_deprecation_warning(self, task_dir, tmp_path, installed_plugins_file, run_hook):
...
class TestActiveTaskGuard:
    ...
    def test_aborts_corrupted_task_file(self, task_dir, hydrate_module, make_task_file):
        """@active-task-guard:1.7 — Corrupted task file causes guard abort."""
        # Create one valid pending task
        make_task_file(task_dir, 1, "pending", "test-skill")
...
class TestPerSkillDeletion:
    ...
    def test_skill_b_preserves_skill_a_tasks(self, tmp_path, run_hook):
    ...
    def test_skill_a_deletes_only_its_tasks(self, tmp_path, run_hook):
    ...
    def test_manual_tasks_preserved_in_deletion(self, tmp_path, run_hook):
    ...
    def test_non_string_fsm_metadata_preserved(self, tmp_path, run_hook):
...
class TestPerSkillIdOffset:
    ...
    def test_offset_includes_other_fsm_tasks(self, tmp_path, run_hook):
    ...
    def test_offset_starts_at_1_with_no_tasks(self, tmp_path, run_hook):
    ...
    def test_corrupted_task_file_aborts_offset(self, tmp_path, run_hook):
...
class TestErrorHandling:
    ...
    def test_deletion_abort_on_fs_error(self, tmp_path, run_hook):
...
class TestIntegration:
    ...
    def test_invoke_skill_b_with_skill_a_active(self, tmp_path, run_hook):
    ...
    def test_re_invoke_skill_a_all_completed(self, tmp_path, run_hook):
    ...
    def test_sequential_skill_a_then_skill_b(self, tmp_path, run_hook):
    ...
    def test_re_invoke_skill_a_after_skill_b(self, tmp_path, run_hook):
    ...
    def test_re_invoke_after_agent_starts_work(self, tmp_path, run_hook):
    ...
    def test_offset_after_scoped_deletion_with_gaps(self, tmp_path, run_hook):
