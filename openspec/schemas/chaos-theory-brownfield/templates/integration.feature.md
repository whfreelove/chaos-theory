...
PROJECT-LEVEL: Flat structure, no delta wrappers.
BROWNFIELD: Derive from actual cross-capability code paths observed.
-->
...
- Derive from actual cross-capability code paths
-->
